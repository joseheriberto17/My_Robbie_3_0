...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOC, S1_Pin|S2_Pin|S3_Pin|S11_Pin
                          |S4_Pin|S9_Pin);

    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_0|GPIO_PIN_1|S10_Pin|S7_Pin
                          |S8_Pin);

    HAL_GPIO_DeInit(GPIOB, S5_Pin|S6_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA9     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(GPIOA, C1_1_Pin|C2_1_Pin);
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(C1_2_GPIO_Port, C1_2_Pin);

    HAL_GPIO_DeInit(C2_2_GPIO_Port, C2_2_Pin);
